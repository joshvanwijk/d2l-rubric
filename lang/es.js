...
D2L.PolymerBehaviors.Rubric.LocalizeBehavior.LangEsBehavior = {
	es: {
		...
		'clearFeedback': 'Limpiar comentarios',
		...
		'criterionFeedback': 'Criterio de comentarios',
		'criterionFeedbackAriaLabel': 'Comentario del criterio {criterionName}, nivel {levelName}',
		'criterionNameAriaLabel': 'Nombre del criterio',
		'criterionOutOf': 'Se le restaron {value} puntos al criterio {name}',
		...
		'levelNameAndPoints': '{levelName} - {number} {number, plural, one {punto} other {puntos}}',
		...
		'pointsMinimum': '{number} {number, plural, one {punto} other {puntos}} mínimo',
		...
		'removeCriterion': 'Quitar el criterio {name}',
		'removeLevel': 'Quitar el nivel {name}',
		'removeOverallLevel': 'Quitar el nivel general {name}',
		...
		'rubricSummaryA11y': 'En primera columna de esta tabla, se muestran el nombre de los criterios y el de los grupos de estos. En la primera fila, se muestran los nombres de los niveles con las puntuaciones si se utiliza un método de puntuación numérico en la rúbrica.',
		'rubricVisibility': 'Visibilidad de la rúbrica',
		'rubricVisibilityAlways': 'La rúbrica es visible para los estudiantes',
		'rubricVisibilityOnceFeedbackPosted': 'La rúbrica se oculta de los estudiantes hasta que se publiquen los comentarios',
		'rubricVisibilityNever': 'La rúbrica se oculta de los estudiantes',
		...
		'total': 'Total',
		'totalScoreAriaLabel': 'Se le restó a la rúbrica una puntuación total de {value} puntos.',
		'moveCriterionUp': 'Mover el criterio {position} hacia arriba',
		'moveCriterionDown': 'Mover el criterio {position} hacia abajo',
		'criterionMoved': 'Ahora {name} es el criterio {position}',
		...
		'rangeStartInvalid': 'El valor de inicio del rango es no válido',
		'closeDialog': 'Cerrar',
		...
		'changeRubricTypeSuccessful': 'Se cambió el tipos de rúbrica a {rubricType}',
