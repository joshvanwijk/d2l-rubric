...
D2L.PolymerBehaviors.Rubric.LocalizeBehavior.LangZhBehavior = {
	zh: {
		...
		'dashOutOf': '— / {outOf}',
		'description': '描述',
		'descriptionInfo': '为您的个人首选项添加描述。该内容不会与学生共享',
		...
		'levelName': '级别名称',
		'levelNameAndPoints': '{levelName} - {number} {number, plural, one {分数} other {分数}}',
		...
		'options': '选项',
		'outOf': '/ {outOf}',
		'overallDescriptionAriaLabel': '{levelName} 级别整体描述',
		'overallFeedback': '总体反馈',
		'overallFeedbackAriaLabel': '{levelName} 级别整体反馈',
		...
		'pointsMinimum': '最低{number}{number, plural, one {分} other {分}}',
		'pointsSaveFailed': '保存分数失败',
		'percentage': '\{number\} %',
		'preview': '预览',
		'initialFeedback': '初始反馈',
		'refreshText': '刷新页面',
		'removeCriterion': '删除 {name} 标准',
		'removeLevel': '删除 {name} 级别',
		'removeOverallLevel': '删除 {name} 整体级别',
		...
		'changeRubricStatusSuccessful': '量规状态已更改为 {status}',
		'editRubric': '编辑量规',
