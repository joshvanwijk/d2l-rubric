		...
		(function() {
			...
			if (hasSymbols) {
				...
				if (supportsStrIterator) {
					...
					var s = new Set(); // eslint-disable-line no-undef
					s.add(0);
					try {
			...
			var isSet;
			if (hasSet) {
				var setSize = Object.getOwnPropertyDescriptor(Set.prototype, 'size').get; // eslint-disable-line no-undef
				isSet = function(set) {
					try {
						setSize.call(set);
						return true;
			...
			var setForEach = hasSet && Set.prototype.forEach; // eslint-disable-line no-undef
...
*/
		...
		// 7.2.11. SameValueZero ( x, y )
			...
			// 1. If Type(x) is different from Type(y), return false.
				...
				// a. If x is NaN and y is NaN, return true.
					...
					if (x === +0 && y === -0) {  // eslint-disable-line no-compare-neg-zero
						return true;
					}
			...
			// 1. If value is not present, then
				...
				// a. Let result be ? Call(iteratorRecord.[[NextMethod]], iteratorRecord.[[Iterator]], « value »).
					var result = iteratorRecord['[[NextMethod]]'].call(iteratorRecord['[[Iterator]]'], arguments[1]); // eslint-disable-line no-redeclare
				}
		...
		*/
			...
			Object.defineProperty(Map.prototype, 'set', {
				...
				// 1. Let M be the this value.
					...
					if (key === -0) { // eslint-disable-line no-compare-neg-zero
						key = 0;
					}
					...
					// a. Let e be the Record {[[Key]], [[Value]]} that is the value of entries[index].
						...
						// i. If itemKind is "key", let result be e.[[Key]].
							...
							// ii. Else if itemKind is "value", let result be e.[[Value]].
								...
								var result = e['[[Value]]']; // eslint-disable-line no-redeclare
							// iii. Else,
							} else {
							// 1. Assert: itemKind is "key+value".
								...
								var result = [ // eslint-disable-line no-redeclare
									e['[[Key]]'],
									e['[[Value]]']
								];
							}
		...
		!function(n) { function t(e) { if (r[e]) return r[e].exports; var o = r[e] = { exports: {}, id: e, loaded: !1 }; return n[e].call(o.exports, o, o.exports, t), o.loaded = !0, o.exports; } var r = {}; return t.m = n, t.c = r, t.p = '', t(0); }({
			0:/*!***********************!*\
			  !*** ./src/global.js ***!
			  \***********************/
			function(n, t, r) { (function(n) { var t = r(/*! ./yaku */80); try { (n || {}).Promise = t, window.Promise = t; } catch (err) { } }).call(t, function() { return this; }()); }, // eslint-disable-line no-empty
			80:/*!*********************!*\
			  !*** ./src/yaku.js ***!
			  \*********************/
				...
				Object.defineProperties(URLSearchParams.prototype, {
					...
					forEach: {
						value: function(callback) {
							...
							this._list.forEach(function(pair, index) { // eslint-disable-line no-unused-vars
						...
						url = (function() {
							...
							try {
								...
								if (Object.prototype.toString.call(window.operamini) === '[object OperaMini]') {
									...
									doc.write('<head><\/head><body><\/body>'); // eslint-disable-line no-useless-escape
									doc.close();
								}
	...
	}).call('object' === typeof window && window || 'object' === typeof self && self || 'object' === typeof global && global || {}); // eslint-disable-line no-undef
}
