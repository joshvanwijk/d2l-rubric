...
suite('entity-store', function() {
	...
	suite('smoke test', function() {
		...
		test('can fetch leaf entity using listener', function(done) {
			...
			window.D2L.Rubric.EntityStore.fetch('static-data/rubrics/organizations/text-only/199/groups/176/criteria/623/0.json', '');
		});

		test('can fetch leaf entity using promise', function(done) {
			var request = window.D2L.Rubric.EntityStore.fetch('static-data/rubrics/organizations/text-only/199/groups/176/criteria/623/0.json', '');
		...
		test('handles entity error using listener', function(done) {
			...
			window.D2L.Rubric.EntityStore.fetch('static-data/rubrics/organizations/text-only/199/groups/176/criteria/623/UNKNOWN1.json', '');
		});

		test('handles entity error using promise', function(done) {
			var request = window.D2L.Rubric.EntityStore.fetch('static-data/rubrics/organizations/text-only/199/groups/176/criteria/623/UNKNOWN2.json', '');
			request.then(function(entity) {
		...
		test('expands embedded entity children', function(done) {
			...
			window.D2L.Rubric.EntityStore.fetch('static-data/rubrics/organizations/text-only/199/groups/176/criteria/623.json', '');
		});
		...
		test('expands embedded entity descendants', function(done) {
			...
			window.D2L.Rubric.EntityStore.fetch('static-data/rubrics/organizations/text-only/199/groups/176/criteria.json', '');
		});
