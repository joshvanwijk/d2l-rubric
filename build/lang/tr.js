...
window.D2L.Rubric.Language.Tr = {
	...
	'activityNameLabel': 'Etkinlik: {name}',
	...
	'addFeedbackFor': '{criterionName} kriteri için geri bildirim ekle',
	...
	'clearFeedbackFor': '{criterionName} kriteri için geri bildirimi temizle',
	'clearOverride': 'Etkisizleştirmeyi Temizle',
	'clearOverrideFor': '{criterionName} kriteri için geçersiz kılmayı temizle',
	'clearOverrideTotal': 'Rubrik toplam puanı için geçersiz kılmayı temizle',
	'closeDialog': 'Kapat',
	'copiedCriterionLoading': '{name} kopyası yükleniyor',
	'copyCriterion': '{criterionName} kriterini kopyala',
	'copyRow': 'Satırı Kopyala',
	'courseNameLabel': 'Ders: {name}',
	'criteriaGroup': 'Ölçüt Grubu',
	'criteriaHeading': 'Kriterler',
	'criterion': 'Ölçüt',
	'criterionAdded': 'Yeni bir kriter eklendi',
	'criterionAlignmentListTitle': '{criterionName} Kriteri için {standardsName}',
	'criterionAriaLabel': 'Kriter {index, number} / {count, number}',
	'criterionCopied': 'Kriter kopyalandı',
	...
	'deleteCriterion': '{criterionName} kriterini sil',
	...
	'moveCriteriaGroupDown': 'Kriter grubunu {positionNumber} konumuna aşağı taşıyın',
	'moveCriteriaGroupUp': 'Kriter grubunu {positionNumber} konumuna yukarı taşıyın',
	...
	'preview': 'Önizle',
	'printRubric': 'Rubrik\'i yazdır',
	'printRubricDescription': 'Rubrik\'i yazdır. Yazdırma ön izleme penceresi açılacaktır.',
	...
	'rubricStructure': 'Bu kriter grubunda {levelCount} seviye ve {criteriaCount} kriter var.',
	'rubricSummaryA11y': 'Bu tablo, ilk sütundaki kriter ve kriter grubu adlarını listeler. İlk satır seviye adlarını listeler ve rubrik sayısal bir puanlama yöntemi kullanıyorsa puanları içerir. Tablodaki geri bildirim ekle düğmelerine dokunarak her bir kriter için geri bildirim verebilirsiniz.',
	...
	'scoreOf': '{criterion} puanı,',
	'scoreOfEditable': '{criterion} puanı. Bir döndürme düğmesiyle puanı ayarlamak için enter tuşuna basabilirsiniz.',
