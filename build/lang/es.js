...
window.D2L.Rubric.Language.Es = {
	...
	'clearOverrideFor': 'Borrar anulación para el criterio {criterionName}',
	'clearOverrideTotal': 'Eliminar anulación de la calificación total de la rúbrica',
	'closeDialog': 'Cerrar',
	...
	'criterionCopied': 'Se copió el criterio',
	...
	'criterionMoved': '{name} se cambió a la posición {positionNumber}.',
	...
	'moveCriteriaGroupDown': 'Mover el grupo de criterios en la posición {positionNumber} hacia abajo',
	'moveCriteriaGroupUp': 'Mover el grupo de criterios en la posición {positionNumber} hacia arriba',
	...
	'printRubric': 'Imprimir rúbrica',
	'printRubricDescription': 'Imprimir rúbrica. Se abrirá una vista previa de impresión.',
	...
	'rubricSummaryA11y': 'Esta tabla muestra los nombres de criterios y de grupos de criterios en la primera columna. En la primera fila, se muestran los nombres de los niveles y se incluyen puntuaciones si se utiliza un método de puntuación numérico en la rúbrica. Puede proporcionar comentarios sobre cada criterio desplazándose hacia los botones Agregar comentarios en la tabla.',
	...
	'scoreOfEditable': 'Puntuación de {criterion}. Puede presionar Intro para ajustar la puntuación con un botón de selección.',
	...
	'standardsAligned': '{standardsName} alineado a {name}',
