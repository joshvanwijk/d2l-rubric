...
D2L.PolymerBehaviors.Rubric.LocalizeBehavior.LangKoBehavior = {
	ko: {
		...
		'numberAndPoints': '{number} {number, plural, =1 {point} 기타 {points}}',
		'options': '옵션',
		'outOf': '/{outOf}',
		...
		'overrideLabel': '재설정',
		'percentage': '{number}%',
		'points': '{number} {number, plural, =1 {point} 기타 {points}}',
		'pointsAbbreviation': '점수',
		'pointsAreRequired': '점수 값이 필요함',
		'pointsMinimum': '{number} {number, plural, =1 {point} 기타 {points}} 최소',
