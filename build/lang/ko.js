...
window.D2L.Rubric.Language.Ko = {
	'actionsforCriterion': '{criterionName} 기준에 대한 작업',
	'actionsforEditRubric': '루브릭 편집에 대한 작업',
	'activityNameLabel': '활동: {name}',
	...
	'clearOverrideFor': '{criterionName} 기준에 대한 재설정 지우기',
	'clearOverrideTotal': '루브릭 총점에 대한 재설정 지우기',
	'closeDialog': '닫기',
	'copiedCriterionLoading': '{name}의 사본이 로드 중입니다.',
	'copyCriterion': '{criterionName} 복사',
	'copyRow': '행 복사',
	'courseNameLabel': '강의: {name}',
	'criteriaGroup': '기준 그룹',
	'criteriaHeading': '기준',
	'criterion': '기준',
	'criterionAdded': '새 기준이 추가되었습니다.',
	'criterionAlignmentListTitle': '기준 {criterionName}에 대한 {standardsName}',
	'criterionAriaLabel': '기준 {index, number}/{count, number}개',
	'criterionCopied': '기준이 복사되었습니다.',
	...
	'criterionMoved': '{name}님이 {positionNumber} 위치로 이동했습니다.',
	'criterionNameAriaLabel': '위치 {positionNumber}에 있는 기준의 이름입니다.',
	...
	'deleteCriterion': '{criterionName} 삭제',
	...
	'moveCriteriaGroupDown': '{positionNumber} 위치에서 기준 그룹을 아래로 이동',
	'moveCriteriaGroupUp': '{positionNumber} 위치에서 기준 그룹을 위로 이동',
	...
	'preview': '미리 보기',
	'printRubric': '루브릭 인쇄',
	'printRubricDescription': '루브릭을 인쇄합니다. 인쇄 미리 보기가 열립니다.',
	...
	'rubricStructure': '이 기준 그룹에는 {levelCount}개 레벨 및 {criteriaCount}개 기준이 있습니다.',
	'rubricSummaryA11y': '이 표에는 첫 번째 열에 기준 및 기준 그룹 이름이 나열됩니다. 루브릭이 숫자 점수 산정법을 사용할 경우, 첫 번째 행에 수준 이름이 나열되고 점수가 포함됩니다. 표의 피드백 추가 버튼을 탭하면 각 기준에 대한 피드백을 제공할 수 있습니다.',
