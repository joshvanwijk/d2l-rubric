...
window.D2L.Rubric.Language.Ar = {
	...
	'addFeedbackFor': 'إضافة ملاحظات حول المعيار {criterionName}',
	...
	'alignmentOptionAutomatic': 'تعيين مستويات التحصيل تلقائيًا إلى النسبة المئوية لمجموع الدرجات',
	'alignmentOptionManual': 'تعيين مستويات التحصيل يدويًا إلى مستويات آلية التقييم',
	...
	'clearFeedbackFor': 'مسح الملاحظات حول المعيار {criterionName}',
	'clearOverride': 'مسح التجاوز',
	'clearOverrideFor': 'مسح التجاوز للمعيار {criterionName}',
	'clearOverrideTotal': 'مسح التجاوز لمجموع درجات آلية التقييم',
	'closeDialog': 'إغلاق',
	'copiedCriterionLoading': 'يتم الآن تحميل نسخة من {name}',
	'copyCriterion': 'نسخ {criterionName}',
	'copyRow': 'نسخ الصف',
	'courseNameLabel': 'المقرر التعليمي: {name}',
	'criteriaGroup': 'مجموعة المعايير',
	'criteriaHeading': 'المعايير',
	'criterion': 'المعيار',
	'criterionAdded': 'تمت إضافة معيار جديد',
	'criterionAlignmentListTitle': '{standardsName} للمعيار {criterionName}',
	'criterionAriaLabel': 'المعيار {index, number} من أصل {count, number}',
	'criterionCopied': 'تم نسخ المعيار',
	...
	'criterionFeedbackWithCopy': 'سيتم الأدراج في الملاحظات العامة والظاهرة للطلاب',
	'criterionMoved': 'تم نقل {name} إلى الموضع {positionNumber}.',
	'criterionNameAriaLabel': 'اسم المعيار في الموضع {positionNumber}.',
	...
	'deleteCriterion': 'حذف {criterionName}',
	...
	'feedback': 'الملاحظات',
	'feedbackOn': 'ملاحظات حول {criterionName}',
	...
	'loaLevelLabelMultiRubric': 'تم تعيين مستوى التحصيل "{loaLevelName}" لمستويَي آلية التقييم {otherRubricLevelNames} و{lastRubricLevelName}',
	'loaLevelLabelSingleRubric': 'تم تعيين مستوى التحصيل "{loaLevelName}" لمستوى آلية التقييم {rubricLevelName}',
	'loaLevelUpdatedLabelMultiRubric': 'تم تعيين مستوى التحصيل "{loaLevelName}" لمستويَي آلية التقييم {otherRubricLevelNames} و{lastRubricLevelName}',
	'loaLevelUpdatedLabelSingleRubric': 'تم تعيين مستوى التحصيل "{loaLevelName}" لمستوى آلية التقييم {rubricLevelName}',
	'loaOverlayHeading': 'مستويات التحصيل',
	'loaSliderLabel': 'يتراوح الحد الأدنى للتحصيل بين "{loaLevel1}" و"{loaLevel2}". استخدم مفتاح السهم لليسار ومفتاح السهم لليمين لنقل الحد الأدنى.',
	...
	'moveCriteriaGroupDown': 'نقل مجموعة المعايير في الموضع {positionNumber} إلى الأسفل',
	'moveCriteriaGroupUp': 'نقل مجموعة المعايير في الموضع {positionNumber} إلى الأعلى',
	...
	'numberAndPoints': '{number} {number, plural, =1 {نقطة واحدة} other {من النقاط}}',
	'options': 'الخيارات',
	'outOf': '/ {outOf}',
	...
	'overallScoreLevel': 'مستوى مجموع الدرجات الإجمالي',
	...
	'overrideLabel': 'تجاوز',
	'percentage': '{number} %',
	'points': '{number} {number, plural, =1 {نقطة واحدة} other {من النقاط}}',
	'pointsAbbreviation': 'نقطة',
	'pointsAreRequired': 'قيمة النقطة مطلوبة',
	'pointsMinimum': '{number} {number, plural, =1 {نقطة واحدة} other {من النقاط}} كحد أدنى',
	'pointsSaveFailed': 'فشل حفظ النقاط',
	'preview': 'معاينة',
	'printRubric': 'طباعة آلية التقييم',
	'printRubricDescription': 'يجب طباعة آلية التقييم. سيتم فتح معاينة للطباعة.',
	...
	'rubricAlignmentSaveFailed': 'تعذّرت محاذاة تغيير آلية التقييم.',
	'rubricFeedbackCopyOption': 'تضمين ملاحظات آلية التقييم في الملاحظات العامة',
	'rubricLevel': 'مستوى آلية التقييم',
	'rubricLevelsHeading': 'مستويات آلية التقييم',
	...
	'rubricStructure': 'تحتوي مجموعة المعايير هذه على {levelCount} من المستويات و{criteriaCount} من المعايير.',
	'rubricSummaryA11y': 'يسرد هذا الجدول أسماء المعايير وأسماء مجموعات المعايير في العمود الأول. يسرد الصف الأول أسماء المستويات ويشمل مجموع الدرجات إذا كانت آلية التقييم تستخدم طريقة رقمية لتسجيل مجموع الدرجات. يمكنك تقديم ملاحظات حول كل معيار من خلال التنقل بمفتاح الجدولة إلى أزرار إضافة ملاحظات في الجدول.',
	...
	'scoreOf': 'درجة {criterion}،',
	'scoreOfEditable': 'درجة {criterion}. يمكنك الضغط على enter لضبط الدرجة باستخدام زر زيادة ونقصان.',
...
D2L.PolymerBehaviors.Rubric.LocalizeBehavior.LangArBehavior = {
	ar: window.D2L.Rubric.Language.Ar
};
