...
window.D2L.Rubric.Language.Pt = {
	...
	'activityNameLabel': 'Atividade: {name}',
	...
	'addedOverallLevelPrepend': 'Um novo nível de pontuação geral foi adicionado antes de {name}',
	'addFeedback': 'Adicionar Comentário',
	'addFeedbackFor': 'Adicionar comentário para o critério {criterionName}',
	...
	'alignmentOptionAutomatic': 'Associar automaticamente níveis de desempenho a pontuações de porcentagem',
	'alignmentOptionManual': 'Associar manualmente níveis de desempenho a níveis de rubrica',
	...
	'clearFeedbackFor': 'Limpar comentário para o critério {criterionName}',
	'clearOverride': 'Limpar Substituir',
	'clearOverrideFor': 'Limpar substituição para o critério {criterionName}',
	'clearOverrideTotal': 'Limpar substituição para a pontuação total da rubrica',
	'closeDialog': 'Fechar',
	...
	'criterionAlignmentListTitle': '{standardsName} para o critério {criterionName}',
	'criterionAriaLabel': 'Critério {index, number} de {count, number}',
	'criterionCopied': 'O critério foi copiado',
	...
	'criterionFeedbackWithCopy': 'será incluída no comentário geral e ficará visível aos alunos',
	...
	'deleteCriterion': 'Excluir {criterionName}',
	...
	'editLevelNameDescription': 'Nome do nível na posição {positionNumber}.',
	'editLevelPointsDescription': 'Pontos obtidos por alcançar {levelName}.',
	...
	'feedbackOn': 'Comentário sobre {criterionName}',
	...
	'levelLoading': 'Um novo {name} está carregando',
	...
	'loaLevelLabelMultiRubric': 'O nível de desempenho "{loaLevelName}" está associado aos níveis de rubrica {otherRubricLevelNames} e {lastRubricLevelName}',
	'loaLevelLabelSingleRubric': 'O nível de desempenho "{loaLevelName}" está associado ao nível de rubrica {rubricLevelName}',
	'loaLevelUpdatedLabelMultiRubric': 'O nível de desempenho "{loaLevelName}" agora está associado aos níveis de rubrica {otherRubricLevelNames} e {lastRubricLevelName}',
	...
	'moveCriteriaGroupDown': 'Mover para baixo o grupo de critérios na posição {positionNumber}',
	'moveCriteriaGroupUp': 'Mover para cima o grupo de critérios na posição {positionNumber}',
	'moveCriterionDown': 'Mover critério {position} para baixo',
	'moveCriterionUp': 'Mover critério {position} para cima',
	'name': 'Nome',
	'nameIsRequired': 'O campo Nome é obrigatório',
	...
	'overallScoreLevel': 'Nível de pontuação geral',
	...
	'pointsMinimum': 'Mínimo: {number} {number, plural, =1 {ponto} other {pontos}}',
	'pointsSaveFailed': 'Falha ao salvar os pontos',
	'preview': 'Visualizar',
	'printRubric': 'Imprimir rubrica',
	'printRubricDescription': 'Imprimir rubrica. Uma visualização de impressão será aberta.',
	...
	'rubricAlignmentSaveFailed': 'Falha ao alterar o alinhamento de rubrica.',
	'rubricFeedbackCopyOption': 'Incluir comentários da rubrica nos comentários gerais',
	'rubricLevel': 'Nível de rubrica',
	'rubricLevelsHeading': 'Níveis de Rubrica',
	...
	'rubricStructure': 'Este grupo de critérios tem {levelCount} nível(eis) e {criteriaCount} critério(s).',
	'rubricSummaryA11y': 'A tabela lista critérios e nomes de grupos de critérios na primeira coluna. A primeira linha lista nomes de níveis e inclui pontuações caso a rubrica use um método de pontuação numérica. Você pode comentar cada critério usando a tecla Tab para acessar os botões e adicionar comentários na tabela.',
	...
	'scoreOf': 'Pontuação de {criterion},',
	'scoreOfEditable': 'Pontuação de {criterion}. Pressione Enter para ajustar a pontuação com um botão de rotação.',
...
D2L.PolymerBehaviors.Rubric.LocalizeBehavior.LangPtBehavior = {
	pt: window.D2L.Rubric.Language.Pt
};
