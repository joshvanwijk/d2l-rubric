...
window.D2L.Rubric.Language.Nl = {
	...
	'addedOverallLevelPrepend': 'Een nieuw niveau voor de algehele score is toegevoegd voor {name}',
	'advancedAvailabilityHeader': 'Geavanceerde beschikbaarheid',
	'alignmentOptionAutomatic': 'Automatisch scoreniveaus toewijzen aan percentagescores',
	'alignmentOptionManual': 'Handmatig scoreniveaus toewijzen aan rubricniveaus',
	...
	'clearFeedbackFor': 'Feedback wissen voor criterium {criterionName}',
	'clearOverride': 'Overschrijven wissen',
	'clearOverrideFor': 'Overschrijving voor criterium {criterionName} wissen',
	'clearOverrideTotal': 'Overschrijving voor totale score rubric wissen',
	'closeDialog': 'Sluiten',
	'copiedCriterionLoading': 'Kopie van {name} wordt geladen',
	'copyCriterion': '{criterionName} kopiëren',
	'copyRow': 'Rij kopiëren',
	'courseNameLabel': 'Cursus: {name}',
	'criteriaGroup': 'Criteriagroep',
	'criteriaHeading': 'Criteria',
	'criterion': 'Criterium',
	'criterionAdded': 'Er is een nieuw criterium toegevoegd',
	'criterionAlignmentListTitle': '{standardsName} voor criterium {criterionName}',
	'criterionAriaLabel': 'Criterium {index, number} van {count, number}',
	'criterionCopied': 'Het criterium is gekopieerd',
	...
	'criterionFeedbackWithCopy': 'worden opgenomen in de algemene feedback en zijn zichtbaar voor studenten',
	'criterionMoved': '{name} verplaatst naar positie {positionNumber}.',
	'criterionNameAriaLabel': 'Naam van het criterium in positie {positionNumber}.',
	'criterionOutOf': 'Criterium {name} is gebaseerd op {value} punten',
	'criterionPlaceholder': 'Klik om het criterium te bewerken',
	'criterionScore': 'Criteriumscore',
	'dashOutOf': '— / {outOf}',
	'deleteConfirmationNo': 'Annuleren',
	'deleteConfirmationYes': 'Verwijderen',
	'deleteCriterion': '{criterionName} verwijderen',
	...
	'feedback': 'Feedback',
	'feedbackOn': 'Feedback op {criterionName}',
	...
	'levelLoading': 'Nieuwe {name} wordt geladen',
	...
	'loaLevelLabelMultiRubric': 'Scoreniveau "{loaLevelName}" is toegewezen aan rubricniveaus {otherRubricLevelNames} en {lastRubricLevelName}',
	'loaLevelLabelSingleRubric': 'Scoreniveau "{loaLevelName}" is toegewezen aan rubricniveau {rubricLevelName}',
	'loaLevelUpdatedLabelMultiRubric': 'Scoreniveau "{loaLevelName}" is nu toegewezen aan rubricniveaus {otherRubricLevelNames} en {lastRubricLevelName}',
	'loaLevelUpdatedLabelSingleRubric': 'Scoreniveau "{loaLevelName}" is nu toegewezen aan rubricniveau {rubricLevelName}',
	'loaOverlayHeading': 'Scoreniveau',
	'loaSliderLabel': 'Scoredrempel tussen \'{loaLevel1}’ en \'{loaLevel2}\'. Gebruik de rechter- en linkerpijltoets om de drempel te verplaatsen.',
	...
	'moveCriteriaGroupDown': 'Criteriagroep omlaag verplaatsen naar positie {positionNumber}',
	'moveCriteriaGroupUp': 'Criteriagroep omhoog verplaatsen naar positie {positionNumber}',
	...
	'overallScoreLevel': 'Algemeen scoreniveau',
	...
	'printRubric': 'Rubric afdrukken',
	'printRubricDescription': 'Druk rubric af. Er wordt een afdrukvoorbeeld geopend.',
	...
	'rubricAlignmentSaveFailed': 'Wijzigen van afstemming rubric mislukt.',
	'rubricFeedbackCopyOption': 'Rubricfeedback toevoegen aan algemene feedback',
	'rubricLevel': 'Rubricniveau',
	'rubricLevelsHeading': 'Rubricniveaus',
	...
	'rubricStructure': 'Deze criteriagroep heeft {levelCount} niveaus en {criteriaCount} criteria.',
	'rubricSummaryA11y': 'In de eerste kolom van deze tabel staan de namen van criteria en criteriagroepen. In de eerste rij staan de niveaunamen en eventueel de scores als de rubric gebruikmaakt van een numerieke scoremethode. U kunt feedback op elk criterium geven door op de knop Feedback toevoegen in de tabel te tikken.',
	...
	'scoreOf': 'Score van {criterion},',
	'scoreOfEditable': 'Score van {criterion}. Druk op Enter om de score aan te passen met een draaiknop.',
...
D2L.PolymerBehaviors.Rubric.LocalizeBehavior.LangNlBehavior = {
	nl: window.D2L.Rubric.Language.Nl
};
