...
D2L.PolymerBehaviors.Rubric.LocalizeBehavior.LangFrBehavior = {
	fr: {
		...
		'loaLevelUpdatedLabel': 'Le niveau de réussite \'{loaLevelName}\' est désormais mappé à la rubrique {rubricLevelCount, plural, one {niveau} other {niveaux}} {rubricLevelNames}',
