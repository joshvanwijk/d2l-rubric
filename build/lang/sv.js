...
window.D2L.Rubric.Language.Sv = {
	'actionsforCriterion': 'Åtgärder för kriteriet {criterionName}',
	...
	'clearOverrideFor': 'Ta bort åsidosättning för kriteriet {criterionName}',
	'clearOverrideTotal': 'Ta bort åsidosättning för totala rubriceringspoäng',
	'closeDialog': 'Stäng',
	'copiedCriterionLoading': 'En kopia av {name} läses in',
	'copyCriterion': 'Kopiera {criterionName}',
	'copyRow': 'Kopiera rad',
	...
	'criterionAlignmentListTitle': '{standardsName} för kriteriet {criterionName}',
	'criterionAriaLabel': 'Kriterium {index, number} av {count, number}',
	'criterionCopied': 'Kriteriet har kopierats',
	...
	'deleteCriterion': 'Ta bort {criterionName}',
	...
	'moveCriteriaGroupDown': 'Flytta kriteriegruppen i position {positionNumber} nedåt',
	'moveCriteriaGroupUp': 'Flytta kriteriegruppen i position {positionNumber} uppåt',
	...
	'printRubric': 'Skriv ut rubricering',
	'printRubricDescription': 'Skriv ut rubricering. En förhandsgranskning av utskriften öppnas.',
	...
	'rubricStructure': 'Den här kriteriegruppen har {levelCount} nivåer och {criteriaCount} kriterier.',
	'rubricSummaryA11y': 'Denna tabell innehåller namn på kriterier och kriteriegrupper i den första kolumnen. På den första raden listas nivånamn och betyg inkluderas om rubriceringen använder en numerisk betygsättningsmetod. Du kan ge feedback per kriterium genom att trycka på knapparna och ange feedbacken i tabellen.',
